...
function myForEach(array, aCallBackFn) {
...
function superMap(array, anotherCallBackFn){
  let newArr = []
  for (let i = 0; i < array.length; i++) {
    newArr.push(anotherCallBackFn(array[i]))
  }
 return newArr
...
const jack = function(word){
  return function(word){
    console.log(`here i am, bum bum, rock you like a hurricane ${word}`)
  }
}

function takesFunctionAsArgument(aCoolFunction){
  return aCoolFunction()
}

takesFunctionAsArgument(jack("pass it in here"))
